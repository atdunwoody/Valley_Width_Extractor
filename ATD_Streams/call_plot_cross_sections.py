...
if __name__ == '__main__':
    ...
    json_file = r"Y:\ATD\GIS\Bennett\Valley Widths\Valley_Footprints\ATD_algorithm\Wavelets\UE\flow_depths.json"    # Replace with the actual path to your JSON file
