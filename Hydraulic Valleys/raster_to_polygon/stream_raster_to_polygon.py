...
def main():
    ...
    #     input_raster_dir= os.path.join(r"Y:\ATD\GIS\Bennett\Valley Widths\Valley_Footprints\Hydraulic Model\Max Depth Rasters", watershed)  # Replace with your input raster path
    ...
    input_raster_dir = r"Y:\ATD\GIS\Valley Bottom Testing\Control Valleys\Terrain\Individual\WBT_Outputs_CO2"  # Replace with your input raster path
    output_vector_dir = r"Y:\ATD\GIS\Valley Bottom Testing\Control Valleys\Terrain\Individual\WBT_Outputs_CO2"
