...
wbe = WbEnvironment()
dem_list = [
    r"Y:\ATD\GIS\ETF\DEMs\LIDAR\OT 2020\ET_middle_LIDAR_2020_1m_DEM.tin.tif",    
    r"Y:\ATD\GIS\ETF\DEMs\LIDAR\OT 2020\ET_upper_LIDAR_2020_1m_DEM.tin.tif",
]
nmae_list = [
    "Middle",
    "Upper",
...
for dem, name in zip(dem_list, nmae_list):
    # Set up working directory, usually where your DEM file is located
    working_dir = os.path.join(os.path.dirname(dem), f"WBT_Outputs_{name}")
    ...
    threshold_list = [100000]  # Define your threshold value for stream extraction
    for threshold in threshold_list:
        ...
        with rasterio.open(os.path.join(working_dir, dem)) as src:
            crs = src.crs
